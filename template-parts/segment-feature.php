<div class="row features mt-5" id="features">
    <h2 class="text-danger text-center mb-5 sec-heading">Features</h2>
...
//                        $post_date = the_time('g:i a') ;
            ...
            if ($index === 0) {
                ...
                <div class="col-md-4 col-sm-12">
                    <a class="stretched-link text-white f-item" href="<?php echo the_permalink(); ?>">
                        <?php
                        if(has_post_thumbnail()){
                ...
                if ($index === $chunk) {
                    if ($chunk === 12) {
                        $output_in_row .= '
                                <div class="row g-0 mb-2">
                                    <div class="container-fluid">
                                        <a class="stretched-link text-white row p-0 m-0 f-item" href="' . get_permalink() . '">
                                            ...
                                            <div class="col-md-8">
                                                <h5 class="my-0">' . get_the_title() . '</h5>
                                ...
                                ';
                        echo '<div class="col-md-4 col-sm-12">' . $output_in_row . '</div>';
                    } else {
                        echo '<div class="col-md-4 col-sm-12">' . $output_in_row . '</div>';
                        $output_in_row = '
                                <div class="row g-0 mb-2">
